...
<div x-data="{
     ...
     class="{{ $dark ? 'bg-ink-900 text-white' : 'bg-white dark:bg-ink-700 text-ink-900 dark:text-white border border-ink-100 dark:border-ink-500' }} rounded-xl px-4 py-3 flex items-center gap-3 shadow-lg">
    ...
    <div class="min-w-0 flex-1">
        ...
        <p class="text-xs {{ $dark ? 'text-ink-300' : 'text-ink-500 dark:text-ink-300' }} leading-snug">Akses lebih cepat, bisa dipakai offline.</p>
    </div>
